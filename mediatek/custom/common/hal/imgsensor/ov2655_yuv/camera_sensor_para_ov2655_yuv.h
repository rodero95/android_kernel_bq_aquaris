...
#ifndef _CAMERA_SENSOR_PARA_OV2650_RAW_H
#define _CAMERA_SENSOR_PARA_OV2650_RAW_H

	/* STRUCT: SENSOR */
#define OV2650_RAW_CAMERA_SENSOR_REG_DEFAULT_VALUE \
		/* ARRAY: SENSOR.reg[11] */\
		{\
			/* STRUCT: SENSOR.reg[0] */\
			{\
...
#define OV2650_RAW_CAMERA_SENSOR_CCT_DEFAULT_VALUE {{0x30a1,0x00},{0x3000,0x1B}}


#endif//#ifndef _CAMERA_SENSOR_PARA_OV2650_RAW_H
