...
static MSDK_SCENARIO_ID_ENUM Mt9P017_CurrentScenarioId = ACDK_SCENARIO_ID_CAMERA_PREVIEW;
...
//	tmp = MT9P017MIPI_read_cmos_sensor(0x30f0);
//	printk(KERN_ERR"s4MT9P017AF_ReadReg 0x30f0 =0x%x \n", tmp);	
//	tmp = tmp | 0x8000;  
////	MT9P017MIPI_write_cmos_sensor(0x30f0,0x8000);
//	MT9P017MIPI_write_cmos_sensor(0x30f0,tmp);
//	MT9P017MIPI_write_cmos_sensor(0x30f2,0xff);
//	
//	tmp = MT9P017MIPI_read_cmos_sensor(0x30f0);
//	printk(KERN_ERR"s4MT9P017AF_ReadReg 0x30f0 =0x%x \n", tmp);	
//	tmp = MT9P017MIPI_read_cmos_sensor(0x30f2);
//	printk(KERN_ERR"s4MT9P017AF_ReadReg 0x30f2 =0x%x \n", tmp);		
