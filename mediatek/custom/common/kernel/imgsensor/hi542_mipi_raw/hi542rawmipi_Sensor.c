...
kal_uint16 HI542MIPI_MAX_EXPOSURE_LINES = HI542MIPI_PV_PERIOD_LINE_NUMS;//650;
kal_uint8  HI542MIPI_MIN_EXPOSURE_LINES = 2;
kal_uint32 HI542MIPI_isp_master_clock;
kal_uint16 HI542MIPI_CURRENT_FRAME_LINES = HI542MIPI_PV_PERIOD_LINE_NUMS;//650;
...
static void HI542MIPI_Sensor_Init(void)
{
	...
	HI542MIPI_write_cmos_sensor(0x0001,0x02);				 
	HI542MIPI_write_cmos_sensor(0x0001,0x01);
	
	HI542MIPI_write_cmos_sensor(0x03d4,0x28);            //  chengxue without
	mdelay(10);
	///////////////////////////////////////////////////
	///////////////////////////////////////////////////
	
//	HI542MIPI_write_cmos_sensor(,0x00);  
...
//	HI542MIPI_write_cmos_sensor(0x003B,0x2C);  
	...
	HI542MIPI_write_cmos_sensor(0x0043,0x20);  
...
//	HI542MIPI_write_cmos_sensor(,0x05);  
	...
	HI542MIPI_write_cmos_sensor(0x0031,0x03);//FF);for 1304x980 ryu  
	HI542MIPI_write_cmos_sensor(0x0032,0x07);//06); for 1304x980 ryu  
	HI542MIPI_write_cmos_sensor(0x0033,0xAC);//B0); for 1304x980 ryu  
	HI542MIPI_write_cmos_sensor(0x0034,0x03);//02); for 1304x980 ryu  
	HI542MIPI_write_cmos_sensor(0x0035,0xD4);//D8); for 1304x980 ryu  
	HI542MIPI_write_cmos_sensor(0x003A,0x00);  
	HI542MIPI_write_cmos_sensor(0x003B,0x2E);  
	HI542MIPI_write_cmos_sensor(0x004A,0x03);  
	HI542MIPI_write_cmos_sensor(0x004B,0xD4);//C8); for 1304x980 ryu  
	HI542MIPI_write_cmos_sensor(0x004C,0x05);  
	HI542MIPI_write_cmos_sensor(0x004D,0x18);//08); for 1304x980 ryu  
...
//	HI542MIPI_write_cmos_sensor(0x0500,0x18);  
	...
	HI542MIPI_write_cmos_sensor(0x0010,0x41);//01);  //01}, for 1304x980 ryu
...
//	HI542MIPI_write_cmos_sensor(0x0619,0x01); 
	HI542MIPI_write_cmos_sensor(0x0619,0x00); 
//	HI542MIPI_write_cmos_sensor(0x0651,0x02); 
//	HI542MIPI_write_cmos_sensor(0x0652,0x10); 
//	HI542MIPI_write_cmos_sensor(0x0654,0x0a); 
//	HI542MIPI_write_cmos_sensor(0x0655,0x05); 
	...
	HI542MIPI_write_cmos_sensor(0x0631,0x18);//08); for 1304x980 ryu  
	HI542MIPI_write_cmos_sensor(0x0632,0x03);  
	HI542MIPI_write_cmos_sensor(0x0633,0xD4);//C8); for 1304x980 ryu  
	HI542MIPI_write_cmos_sensor(0x0663,0x05);  //0a},trail time 
	HI542MIPI_write_cmos_sensor(0x0660,0x03);  	
	
	//HI542MIPI_write_cmos_sensor(0x0119,0x00);   
	//HI542MIPI_write_cmos_sensor(0x011A,0x2b);   
	//HI542MIPI_write_cmos_sensor(0x011B,0x80);   
...
void HI542MIPI_SetShutter(kal_uint16 iShutter)
{
    ...
    spin_lock_irqsave(&hi542mipi_drv_lock,flags);
    HI542MIPI_pv_exposure_lines = iShutter;
	spin_unlock_irqrestore(&hi542mipi_drv_lock,flags);
    /*  shutter calc
            EXPTIME[28:0]={EXPTIMEH[4:0],EXPTIMEM1[7:0],EXPTIMEM2[7:0],EXPTIMEL[7:0]}
            Exposure time = EXPTIME/OPCLK       in pixels
    ...
    HI542MIPI_write_shutter(iShutter);
...
void HI542MIPI_Set_Mirror_Flip(kal_uint8 image_mirror)
{
	...
	iTemp = HI542MIPI_read_cmos_sensor(0x3818) & 0x9f;	//Clear the mirror and flip bits.
    switch (image_mirror)
	{
	    case IMAGE_NORMAL:
	        HI542MIPI_write_cmos_sensor(0x3818, iTemp | 0xc0);	//Set normal
	         HI542MIPI_write_cmos_sensor(0x3621, 0xc7);
			
                //SET_FIRST_GRAB_COLOR(BAYER_Gr);
	        break;

		case IMAGE_V_MIRROR:
			HI542MIPI_write_cmos_sensor(0x3818, iTemp | 0xe0);	//Set flip
			HI542MIPI_write_cmos_sensor(0x3621, 0xc7);
		...
		case IMAGE_H_MIRROR:
			HI542MIPI_write_cmos_sensor(0x3818, iTemp | 0x80);	//Set mirror
			HI542MIPI_write_cmos_sensor(0x3621, 0xe7);
                //SET_FIRST_GRAB_COLOR(BAYER_Gr);
			break;
				
	    case IMAGE_HV_MIRROR:
	        HI542MIPI_write_cmos_sensor(0x3818, iTemp | 0xa0);	//Set mirror and flip
	        HI542MIPI_write_cmos_sensor(0x3621, 0xe7);
                //SET_FIRST_GRAB_COLOR(BAYER_B);
	        break;
    }
	...
	printk("\r\n zhaoshaopeng iTemp=%d \r\n", iTemp);
    switch(3)//(image_mirror)
	{
	    case IMAGE_NORMAL:
		...
		case IMAGE_V_MIRROR:
		 ...
		 iTemp = HI542MIPI_read_cmos_sensor(0x0011);
		 printk("\r\n zhaoshaopeng iTemp=%d \r\n", iTemp);
                //SET_FIRST_GRAB_COLOR(BAYER_B);
			break;
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
...

    {
        ...
        HI542MIPI_Set_Mirror_Flip(sensor_config_data->SensorImageMirror);//zhaoshaopeng add
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    if ((image_window->ImageTargetWidth<= HI542MIPI_IMAGE_SENSOR_PV_WIDTH) &&
        (image_window->ImageTargetHeight<= HI542MIPI_IMAGE_SENSOR_PV_HEIGHT)) {
        ...
        shutter = ((UINT32)(shutter*(HI542MIPI_FULL_PERIOD_PIXEL_NUMS + HI542MIPI_PV_PERIOD_EXTRA_PIXEL_NUMS + HI542MIPI_PV_dummy_pixels))) /
                                                        ((HI542MIPI_FULL_PERIOD_PIXEL_NUMS+ HI542MIPI_FULL_PERIOD_EXTRA_PIXEL_NUMS + HI542MIPI_dummy_pixels)) ;
        shutter = shutter * HI542MIPI_CAP_pclk / HI542MIPI_PV_pclk;     
    ...
    if(HI542MIPI_5M == HI542MIPI_g_RES) //add start
    {
        sensor_config_data->DefaultPclk = 84000000;
        sensor_config_data->Pixels = HI542MIPI_FULL_PERIOD_PIXEL_NUMS + HI542MIPI_PV_PERIOD_EXTRA_PIXEL_NUMS + HI542MIPI_PV_dummy_pixels;
        sensor_config_data->FrameLines =HI542MIPI_FULL_PERIOD_LINE_NUMS+HI542MIPI_PV_dummy_lines;
    }
    else
    {
        sensor_config_data->DefaultPclk = 32500000;
        sensor_config_data->Pixels = HI542MIPI_FULL_PERIOD_PIXEL_NUMS + HI542MIPI_PV_PERIOD_EXTRA_PIXEL_NUMS+HI542MIPI_dummy_pixels;
        sensor_config_data->FrameLines =HI542MIPI_FULL_PERIOD_LINE_NUMS+HI542MIPI_dummy_lines;
    }
...
{
    pSensorResolution->SensorFullWidth=IMAGE_SENSOR_FULL_WIDTH - 50*HI542MIPI_IMAGE_SENSOR_PV_STARTX;
    pSensorResolution->SensorFullHeight=IMAGE_SENSOR_FULL_HEIGHT - 47*HI542MIPI_IMAGE_SENSOR_PV_STARTY;
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    switch(ScenarioId)
    {
    	case MSDK_SCENARIO_ID_CAMERA_ZSD:
			 pSensorInfo->SensorPreviewResolutionX=IMAGE_SENSOR_FULL_WIDTH - 50*HI542MIPI_IMAGE_SENSOR_PV_STARTX;
			 pSensorInfo->SensorPreviewResolutionY=IMAGE_SENSOR_FULL_HEIGHT - 47*HI542MIPI_IMAGE_SENSOR_PV_STARTY;
    ...
    pSensorInfo->SensorFullResolutionX=IMAGE_SENSOR_FULL_WIDTH - 50*HI542MIPI_IMAGE_SENSOR_PV_STARTX;
    pSensorInfo->SensorFullResolutionY=IMAGE_SENSOR_FULL_HEIGHT - 47*HI542MIPI_IMAGE_SENSOR_PV_STARTY;
...
UINT32 HI542MIPISetTestPatternMode(kal_bool bEnable)
{
    ...
    if(bEnable) {   // enable color bar   
	 ...
	 HI542MIPI_write_cmos_sensor(0x503D, 0x80);
...
{    
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PERIOD:
			...
			{
				case MSDK_SCENARIO_ID_CAMERA_ZSD:
            		*pFeatureReturnPara16++=HI542MIPI_PV_PERIOD_EXTRA_PIXEL_NUMS + HI542MIPI_FULL_PERIOD_PIXEL_NUMS + 130 + HI542MIPI_dummy_pixels;//HI542_PV_PERIOD_PIXEL_NUMS+HI542_dummy_pixels;
            		*pFeatureReturnPara16=HI542MIPI_FULL_PERIOD_LINE_NUMS+HI542MIPI_FULL_PERIOD_EXTRA_LINE_NUMS+HI542MIPI_dummy_lines;
            		*pFeatureParaLen=4;
            	break;
				
				default:
            		*pFeatureReturnPara16++=HI542MIPI_PV_PERIOD_EXTRA_PIXEL_NUMS + HI542MIPI_FULL_PERIOD_PIXEL_NUMS + 130 + HI542MIPI_dummy_pixels;//HI542_PV_PERIOD_PIXEL_NUMS+HI542_dummy_pixels;
            		*pFeatureReturnPara16=HI542MIPI_PV_PERIOD_LINE_NUMS+HI542MIPI_PV_PERIOD_EXTRA_LINE_NUMS+HI542MIPI_dummy_lines;
            		*pFeatureParaLen=4;
            	break;
			}
			break;
