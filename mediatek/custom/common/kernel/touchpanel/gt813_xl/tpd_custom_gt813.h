...
#define TPD_VERSION_INFO_REG 240   // 0xF7D  ?
...
0x0A,0x19,0x0B,0x1A,0xFF,0x10,0x0F,0x0E,
0x0D,0x0C,0x0B,0x0A,0xFF,0xFF,0x03,0x0D,
0x04,0x0E,0x05,0x0F,0x06,0x10,0x07,0x11,
0x08,0xFF,0xFF,0x0D,0x0E,0x0F,0x10,0x11,
0x12,0x13,0x1B,0x03,0x10,0x10,0x10,0x30,
0x00,0x00,0x06,0x00,0x00,0x00,0x40,0x30,
0x20,0x03,0x00,0x05,0x00,0x02,0x1C,0x03,
0xC0,0x4F,0x4F,0x4A,0x4A,0x0A,0x00,0x23,
0x19,0x05,0x14,0x10,0x03,0x16,0x00,0x07,
0x10,0x30,0x50,0x00,0x40,0x30,0x20,0x14,
...
#define TPD_HAVE_TOUCH_KEY
	...
	#define TPD_KEY_HOME 0x04 //not use
	
	const u8 touchKeyArray[] = { KEY_MENU, KEY_BACK };
	...
	const u8 touchKeyArray[] = { KEY_MENU, KEY_HOME, KEY_BACK };
	#define TPD_TOUCH_KEY_NUM ( sizeof( touchKeyArray ) / sizeof( touchKeyArray[0] ) )
#endif
#endif
