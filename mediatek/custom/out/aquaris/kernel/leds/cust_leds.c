...
unsigned int brightness_mapping(unsigned int level)
#if 0//zhaoshaopeng for backlight noise issue 20120425
{
...
//fn00401 zhaoshaopeng exchange red and green 20120314 start
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	//{"red",               MT65XX_LED_MODE_PMIC, MT65XX_LED_PMIC_NLED_ISINK4,{0}},//zhaoshaopeng for aq
