...
static struct alsps_hw cust_alsps_hw = {
    ...
    //OK.als_level  = { 4, 40,  80,   120,   160, 250,  400, 800, 1200,  1600, 2000, 3000, 5000, 10000, 65535},
    //OK.als_value  = {0, 20,20,  120, 120, 280,  280,  280, 1600,  1600,  1600,  6000,  6000, 9000,  10240, 10240},
    //Huawei.als_level  = { 0, 12, 16,  20, 24, 30 ,36,  40,  48 ,  100, 800, 2000, 5000, 10000, 65535},
    //Huawei.als_value  = {10, 20,20,  45, 60, 80, 120, 140, 225, 320,  640,  2600,  6000, 9000,  10240, 10240},
    .als_level  = { 0, 4, 15, 40, 60, 90, 120, 200, 350, 500, 800, 1200, 2000, 4000, 10000, 65535},
    .als_value  = {10, 20, 30, 80, 120, 280, 400, 600, 1600, 2000, 3500, 6000, 6000, 9000,  10240, 10240},
