/* mediatek/platform/mt6577/kernel/drivers/uart/uart.c
 *
 * (C) Copyright 2008 
...
/*------ IRQ Section -----------------------*/
#define UART1_IRQ_ID	MT6577_UART1_IRQ_ID
#define UART2_IRQ_ID	MT6577_UART2_IRQ_ID
#define UART3_IRQ_ID	MT6577_UART3_IRQ_ID
#define UART4_IRQ_ID	MT6577_UART4_IRQ_ID

#define UART1_VFF_TX_IRQ_ID  MT6577_DMA_UART0_TX_IRQ_ID
#define UART1_VFF_RX_IRQ_ID  MT6577_DMA_UART0_RX_IRQ_ID
#define UART2_VFF_TX_IRQ_ID  MT6577_DMA_UART1_TX_IRQ_ID
#define UART2_VFF_RX_IRQ_ID  MT6577_DMA_UART1_RX_IRQ_ID
#define UART3_VFF_TX_IRQ_ID  MT6577_DMA_UART2_TX_IRQ_ID
#define UART3_VFF_RX_IRQ_ID  MT6577_DMA_UART2_RX_IRQ_ID
/*------ PDN Section -----------------------*/
