...
//fenggy add	
	...
	retval = platform_device_register(&actuator_dev6);
    if (retval != 0){
        return retval;
    }	
	retval = platform_device_register(&actuator_dev7);
    if (retval != 0){
        return retval;
    }	
