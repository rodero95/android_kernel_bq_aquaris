...
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
    ...
    RAW_INFO(S5K4E1FX_SENSOR_ID, SENSOR_DRVNAME_S5K4E1FX_MIPI_RAW,NULL), 
#endif

#if defined(S5K5CAGX_MIPI_YUV)
    YUV_INFO(S5K5CAGXMIPI_SENSOR_ID, SENSOR_DRVNAME_S5K5CAGX_MIPI_YUV, NULL), 
#endif
    ...
    YUV_INFO(OV7692_SENSOR_ID, SENSOR_DRVNAME_OV7692_YUV, NULL), 
#endif
    ...
    RAW_INFO(OV5647AMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5647AMIPI_RAW, NULL), 
#endif
//zhaoshaopeng add this
